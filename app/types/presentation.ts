...
export interface NumberPointsContent {
  title: string;
  points: string[];
}

// Unified Slide Interface
export interface SlideConfig {
  type?: SlideType;  // Optional now since element-based slides don't need it
  content?: 
    | TitleSlideContent 
    | TwoColumnContent 
    | ImageSlideContent 
  ...
  elements?: Array<{
    ...
    shape_type?: string;
    fill_color?: { red?: number; green?: number; blue?: number };
  }>;
}
